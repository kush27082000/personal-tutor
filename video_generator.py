...
# Mock function to generate image
def mock_generate_image(prompt, index):
    # Use a placeholder image URL for testing
    # image_url = "https://www.freightwaves.com/wp-content/uploads/2019/07/FWLIVE_CHI_Web-05.png"
    # urllib.request.urlretrieve(image_url, f"images/image{index}.jpg")
    # print(f"Mocked Image Saved in Images Folder as image{index}.jpg!")
    image_url = "https://www.freightwaves.com/wp-content/uploads/2019/07/FWLIVE_CHI_Web-05.png"
    
    # Adding a User-Agent header
    req = urllib.request.Request(image_url, headers={'User-Agent': 'Mozilla/5.0'})
    with urllib.request.urlopen(req) as response:
        with open(f"images/image{index}.jpg", 'wb') as out_file:
...
i = 1
for para in paragraphs[:-1]:
    print("Mock Generate New AI Image From Paragraph...")
    mock_generate_image(para.strip(), i)

    # Create gTTS instance and save to a file
    tts = gTTS(text=para, lang='en', slow=False)
    tts.save(f"audio/voiceover{i}.mp3")
    print(f"The Paragraph Converted into VoiceOver & Saved in Audio Folder as voiceover{i}.mp3!")
